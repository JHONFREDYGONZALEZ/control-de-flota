...
export default async function VehiclePage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6 pb-24">
      ...
      <div className="mt-6">
        <h3 className="text-xs uppercase text-dim tracking-wide mb-3">1 · Órdenes de trabajo</h3>
      ...
      {/* 2. entrega */}
      <div className="mt-6">
        <h3 className="text-xs uppercase text-dim tracking-wide mb-3">2 · Entrega de vehículo</h3>
        {(deliveries || []).length === 0 ? (
      ...
      {/* 3. documentos */}
      <div className="mt-6">
        <h3 className="text-xs uppercase text-dim tracking-wide mb-3">3 · Documentos</h3>
        {(documents || []).map((doc) => {
      ...
      {/* 4. mantenimientos */}
      <div className="mt-6">
        <h3 className="text-xs uppercase text-dim tracking-wide mb-3">4 · Parámetros mantenimiento y reparaciones</h3>
        {(items || []).map((it) => {
